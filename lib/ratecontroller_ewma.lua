            ...
            if reflector_list then
                ...
                elseif #up_del == 0 or #down_del == 0 then
                    ...
                    if up_del_stat and down_del_stat then
                        down_utilisation = BYTES_TO_KBITS * (cur_rx_bytes - prev_rx_bytes) / (now_t - t_prev_bytes)
                        rx_load = down_utilisation / cur_dl_rate
                        up_utilisation = BYTES_TO_KBITS * (cur_tx_bytes - prev_tx_bytes) / (now_t - t_prev_bytes)
