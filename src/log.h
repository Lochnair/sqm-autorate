...
/*
 * Current versions of GCC does not support __FILE_NAME__,
 * so if it's not defined use __FILE__ instead.
 * 
 * Support for __FILE_NAME__ is due to be added in GCC 12
 */
